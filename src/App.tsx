                   ...
                   {activeTab === 'admin-dashboard' && (
                     <div className="p-6 space-y-6 pb-24">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                         ...
                         <button onClick={() => setActiveTab('admin-records')} className="bg-slate-900 border border-slate-800 p-6 rounded-3xl flex flex-col items-center gap-2 hover:border-orange-500/30 transition-all"><FileText className="text-[#ff8c00] w-8 h-8"/><span className="font-bold text-sm">Logs Diarios</span></button>
                         <button onClick={() => setActiveTab('admin-export')} className="bg-slate-900 border border-slate-800 p-6 rounded-3xl flex flex-col items-center gap-2 hover:border-orange-500/30 transition-all"><Download className="text-[#ff8c00] w-8 h-8"/><span className="font-bold text-sm">Exportar PDF</span></button>
                       </div>
